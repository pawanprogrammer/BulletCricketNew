    ...
    public static void livehelper() {
        ...
        try {
            ...
            for (int i = 0; i < ja.length(); i++) {
                ...
                if (jo2.getString("status").toString().equalsIgnoreCase("started")
                        /*|| jo2.getString("status").toString().equalsIgnoreCase("completed")*/
                        || jo2.getString("status").toString().equalsIgnoreCase("notstarted")) {
                    HashMap<String, String> hashMap = new HashMap<>();
                    hashMap.put("status", jo2.getString("status"));
                    ...
                    /*add the winning ratio to hashmap*/
                    JSONObject jObjWinning = jo2.getJSONObject("winning_ratio");
                    hashMap.put("awin", jObjWinning.getString("a"));
                    hashMap.put("bwin", jObjWinning.getString("b"));
